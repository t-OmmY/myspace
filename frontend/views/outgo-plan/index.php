...
/* @var $searchModel common\models\OutgoPlanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Outgo Plans');
...
<div class="outgo-plan-create">
    <?= $this->render('_form', [
        'model' => $model,
    ]) ?>
</div>

<div class="outgo-plan-index">
    <?php Pjax::begin(); ?>
    <?= GridView::widget([
        'tableOptions' => [
...
//        ],
        'columns' => [
            ...
            [
                ...
                'noWrap' => true,
                'width' => '150px',
                'filter' => ArrayHelper::map(OutgoPlan::find()
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    return '/outgo-plan/' . $action . '?id=' . $key;
                },
